  ...
  return (
    <html lang="pt-BR" className="h-full">
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,500;0,600;1,500&family=Cormorant+Garamond:ital,wght@0,500;1,500&family=Bebas+Neue&display=swap"
          rel="stylesheet"
        />
      </head>
